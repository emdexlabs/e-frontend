...
const industries = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1605000797499-95a51c5269ae?q=80&w=1200",
    challenges: [
  ...
  return (
    ...
    >
      <div className="container-width">
        ...
        {/* 3x3 Grid Layout - Refined Spacing */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-fr">
          {industries.map((industry, index) => (
            <motion.div
              ...
              className="group relative h-[420px] rounded-3xl overflow-hidden cursor-pointer shadow-sm hover:shadow-2xl transition-all duration-300 bg-card border border-border"
            >
              {/* Background Image */}
              <div
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-between z-10">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/90 line-clamp-2 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300 font-medium">
                     {industry.tagline}
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between border-t border-white/20 pt-5 mt-auto">
                  <span className="text-xs uppercase tracking-wider font-bold text-white/80 group-hover:text-[#00f5ff] transition-colors">
                    Discover Solutions
                  </span>
                  <div className="w-10 h-10 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center group-hover:bg-[#00f5ff] group-hover:text-black transition-colors duration-300">
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar relative">
                ...
                <div className="bg-background relative p-6 md:p-8 space-y-10 pb-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      {selectedIndustry.solutions.map((sol, idx) => (
                        <motion.div
                          ...
                          key={idx}
                          className="group relative p-6 rounded-2xl bg-secondary hover:bg-secondary/80 border border-border/60 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 overflow-hidden"
                        >
                          ...
                          <div className="relative z-10">
                            ...
                            <h4 className="font-extrabold text-lg text-foreground mb-3 leading-snug group-hover:text-primary transition-colors">
                              {sol.title}
                            </h4>
                  ...
                  {/* 2. Challenges List */}
                  <div className="rounded-2xl bg-secondary/40 border border-border/50 p-6">

...
const BentoCard = ({
  ...
  <motion.div
    ...
    className={`bg-card/50 border border-border p-8 rounded-2xl relative overflow-hidden group hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 shadow-sm ${className}`}
  >
    {children}
  </motion.div>
);
      ...
      <div className="container-width">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[minmax(160px,auto)]">
          ...
          <BentoCard className="flex flex-col" delay={0.4}>
            {/* Background Code Snippet Visual */}
            <div className="absolute inset-0 z-0 opacity-20 pointer-events-none p-6 font-mono text-[10px] leading-relaxed select-none overflow-hidden">
              <span className="text-primary">const</span> <span className="text-blue-300">Architecture</span> = <span className="text-primary">item</span>.<span className="text-yellow-300">optimize</span>({"{"}
              <br />
              &nbsp;&nbsp;<span className="text-cyan-300">scalability</span>: <span className="text-green-400">true</span>,
              <br />
              &nbsp;&nbsp;<span className="text-cyan-300">latency</span>: <span className="text-green-400">&quot;0ms&quot;</span>,
              <br />
              &nbsp;&nbsp;<span className="text-cyan-300">security</span>: <span className="text-primary">Security</span>.<span className="text-yellow-300">MAX</span>
              <br />
              {"}"});
            </div>
